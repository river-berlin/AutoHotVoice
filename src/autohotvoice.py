...
The following example demonstrates how to configure and use the `AutoHotVoice` module:
...
----------------------
- `DEEPGRAM_API_KEY`: API key for Deepgram's transcription service.
- `GEMINI_API_KEY`: API key for Gemini's AI service (if used within the hooks).
"""
import time
